...
namespace SoccerBotApp.Channels
{
    public class BluetoothChannel : ChannelBase
    {
        ...
        public BluetoothChannel(DeviceInformation deviceInfo)
        {
            ...
            Logger.Instance.NotifyUserInfo("BT Channel", "Created");
        }
        ...
        public override async Task<bool> ConnectAsync()
        {
            ...
            try
            {
                ...
                Logger.Instance.NotifyUserInfo("BT Channel", "Connected!");
                return true;
            }
            catch (Exception ex)
            {
                Logger.Instance.NotifyUserError("BT Channel", ex.Message);
                return false;
            }
        }
        ...
        private async void ReceiveDataAsync(DataReader reader)
        {
            ...
            {
                Logger.Instance.NotifyUserError("BT Channel", "Could Not Connect" + ex.Message);
                State = States.Disconnected;
                InvokeDisconnected();
            }
        }
        ...
        public override async void Connect()
        {
            ...
            {
                Logger.Instance.NotifyUserError("BT Channel", "This app does not have access to connect to the remote device (please grant access in Settings > Privacy > Other Devices");
                return;
            }
            ...
            try
            {
                ...
                {
                    Logger.Instance.NotifyUserError("BT Channel", "Bluetooth Device returned null. Access Status = " + accessStatus.ToString());
                    return;
                }
                ...
                {
                    Logger.Instance.NotifyUserError("BT Channel", "Could not discover any remote devices.");
                    return;
                }
